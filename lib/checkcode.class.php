...
class checkcode {
	...
	function __construct() {
		$rand = rand(0,1);
		if($rand==0) {
			$this->font = ROOT_PATH.'lib'.DIRECTORY_SEPARATOR.'data'.DIRECTORY_SEPARATOR.'font'.DIRECTORY_SEPARATOR.'elephant.ttf';
		} else {
			$this->font = ROOT_PATH.'lib'.DIRECTORY_SEPARATOR.'data'.DIRECTORY_SEPARATOR.'font'.DIRECTORY_SEPARATOR.'Vineta.ttf';
		}
	}
